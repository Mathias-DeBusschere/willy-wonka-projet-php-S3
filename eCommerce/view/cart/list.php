...
$i = 0;
	...
	echo '<a href="index.php?controller=cart&action=deleteFromCart&idCommande='.$i.'"><img src="images/header/settings.png" alt="delete" style="width: 30px;height: 30px;background-color: #888A8588;border-radius: 100%;justify-content: space-around;align-items: center;"></a>';
