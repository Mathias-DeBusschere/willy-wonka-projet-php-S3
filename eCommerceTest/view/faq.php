			...
			<article><!-- reponses aux questions -->
				...
				<ul>
					...
					<li class="deroulant" id="questionreponse2">
						...
						<div class="reponse">
							<p>
								Pour contacté notre entreprise, vous pouvez deposé un message directement sur notre <a href="contact.html">page contact.</a>
							</p>
						</div>
					...
					<li class="deroulant" id="questionreponse3">
						...
						<div class="reponse">
							<p>
								Pour acheter du chocolat, il vous suffit de vous rendre dans un de nos commerces, ou bien de procédé a l'achat directement sur <a href="chocolategeneral.html">notre page produit.</a>
							</p>
						</div>
