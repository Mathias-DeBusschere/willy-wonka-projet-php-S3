		...
		<article class="other_product_article">
			<a href="index.php?action=read&id='.$chocolat->getId().'">
				...
				<a href="index.php?action=delete&id='.$chocolat->getId().'">
					<img src="images/header/delete.png" alt="delete" style="position: absolute;left: 3px;bottom: 3px;width: 30px;height: 30px;background-color: #888A8588;border-radius: 100%;display: flex;justify-content: space-around;align-items: center;">
				</a>
		</article>';
	}
